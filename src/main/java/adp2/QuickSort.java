...
public class QuickSort {
     ...
     */
    public static void sort(Comparable[] a, Median median) {
        // StdRandom.shuffle(a);
    ...
    private static void sort(Comparable[] a, int lo, int hi, Median median) {
        if (hi <= lo) return;
        ...
        int j = partition(a, lo, hi, median);
    ...
    private static int partition(Comparable[] a, int lo, int hi, Median median) {
        int n = hi - lo + 1;
    ...
    private static int median5(Comparable[] ary, int a, int b, int c, int d, int e) {
        ...
        Comparable[] median = new Comparable[]{ary[a], ary[b], ary[c], ary[d], ary[e]};
