...
public class BinarySearchMultiST<Key extends Comparable<Key>, Value> {
    ...
    public Iterable<Value> getAll(Key key){
        ...
        int i1 = i;
        while ( i1 < keys.length-1 && key.compareTo(keys[i1]) == 0) {
          values.add(vals[i1]);
          i1++;
        };

        int i2 = --i;
        while ( i2 >= 0 && key.compareTo(keys[i2]) == 0) {
            values.add(vals[i2]);
            i2--;
        };
...
//        }
    ...
    public static void main(String[] args) {
        ...
        List<String> keys = new ArrayList<>(List.of("S", "E", "A", "R", "C", "H", "E", "X", "A", "M", "P", "L", "E", "E", "X"));
        ...
        System.out.println(st.getAll("A"));
        System.out.println(st.getAll("X"));
        System.out.println(st.getAll("E"));
