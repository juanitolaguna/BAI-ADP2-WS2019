...
public class BoyerMoore {
    ...
    public static void main(String[] args) {
        String pat = "abba";
        String txt = "dabbacccddddabbabbaccdabbccabbacdd";
        char[] pattern = pat.toCharArray();
        char[] text    = txt.toCharArray();

        BoyerMoore boyermoore1 = new BoyerMoore(pat);
        int offset1 = boyermoore1.search(txt);
        List<Integer> listMatches = boyermoore1.findAll(txt);


       System.out.println("Find firs occurence: " + offset1);
       System.out.println("Find all occurences " + listMatches);
    }
}
