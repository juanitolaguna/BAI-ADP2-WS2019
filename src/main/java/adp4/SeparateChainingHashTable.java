/******************************************************************************
 *  Compilation:  javac SeparateChainingHashTable.java
 *  Execution:    java SeparateChainingHashTable < input.txt
...
/**
 * The {@code SeparateChainingHashTable} class represents a symbol table of
...
public class SeparateChainingHashTable<Key, Value> {
    ...
    /**
     * Unit tests the {@code SeparateChainingHashTable} data type.
     *
     * @param args the command-line arguments
     */
    public static void main(String[] args) {
        SeparateChainingHashTable<Character, Integer> st = new SeparateChainingHashTable<>();
